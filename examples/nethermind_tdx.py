...
- TDX-enabled kernel with hardened command line
...
def build_nethermind_base() -> Image:
    ...
    # TDX kernel with hardened command line
    img.kernel = Kernel.tdx_kernel("6.8", cmdline=KERNEL_CMDLINE)
    ...
    # Skeleton: files placed before package manager runs
